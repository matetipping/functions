...
var awards = {
	...
	if ($("div#top strong a").attr("href").indexOf('/profile/' + award[0] + '/') !== -1) {
	    ...
	    $("marquee#card_marquee img:nth-child(" + c_number + ")").replaceWith('<img onmouseover="awards.tooltip.open(event,' + a + ');" onmouseout="awards.tooltip.bye(' + a + ');" id="' + a + '-award" src="' + award[2] + '" alt="' + award[1] + '" width="' + t_award.thumbnail[0] + 'px" height="' + t_award.thumbnail[1] + 'px" />');
	}
    },
    tooltip: {
        current: 0,
