function change_career_options() {
    ...
    if (profession === "0") {
            $("select#attr_career").html("<option value='0'>Random</option><option value='1'>Farmer</option><option value='2'>Fisherman</option><option value='3'>Shepherd</option><option value='4'>Fletcher</option>");
    } else if (profession === "1") {
            $("select#attr_career").html("<option value='0'>Random</option><option value='1'>Librarian</option><option value='2'>Cartographer</option>");
    } else if (profession === "2") {
            $("select#attr_career").html("<option value='0'>Random</option><option value='1'>Cleric</option>");
    } else if (profession === "3") {
            $("select#attr_career").html("<option value='0'>Random</option><option value='1'>Armorer</option><option value='2'>Weaponsmith</option><option value='3'>Tool Smith</option>");
    } else if (profession === "4") {
            $("select#attr_career").html("<option value='0'>Random</option><option value='1'>Butcher</option><option value='2'>Leatherworker</option>");
    } else {
            $("select#attr_career").html("<option value='0'>Random</option>");
    }
}
