...
var awards = {
    ...
    tooltip: {
        ...
        open: function(event, a) {
            ...
            if ($("#" + a + "-tooltip").size() === 0) $("body").append('<div id="' + a + '-tooltip" style="position:absolute;max-width:500px; padding: 0px; background: #08141E; border-radius: 20px; box-shadow: 0px 0px 1px #000; border: 1px solid #ED6030; color: #C3C9D7;"><table><tbody><tr><td><img src="' + award[2] + '" alt="' + award[1] + '" /></td><td>' + award[1] + '<hr />' + award[3] + '<hr /><strong>Received:</strong> ' + award[4] + '</td></tr></tbody></table></div>');
